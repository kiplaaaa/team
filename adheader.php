...
<body class="theme-cyan"  style="background-color:#87CEEB">
    <!-- Page Loader -->
...
?>
    ...
    <div class="menu" style="background-color:white">
        <ul class="list" style="overflow: hidden; width: auto; height: calc(-184px + 100vh);">
            ...
            <li>
                <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-calendar-check"></i><span>Profile</span> </a>
                <ul class="ml-menu">
...
?>
                ...
                <ul class="list">
                    ...
                    <li><a href="javascript:void(0);" class="menu-toggle"><i
                        ...
                        <ul class="ml-menu">
                            ...
                            <li><a href="viewappointment.php">View Patient records</a></li>
                        </ul>
                    </li>
            ...
            <div class="menu" style="background-color:#663399">
                <ul class="list">
                    ...
                    <li><a href="javascript:void(0);" class="menu-toggle"><i
                                class="zmdi zmdi-calendar-check"></i><span>Appointment and Reports</span> </a>
                        <ul class="ml-menu">
                            <li><a href="patientappointment.php" >Add Appointment</a></li>
                            <li><a href="viewappointment.php" >View Appointments and Reports</a></li>
                        </ul>
                    </li>
                    <li><a href="javascript:void(0);" class="menu-toggle"><i
                ...
                <li>  <!-- Add this button where you want the logout button to appear -->
