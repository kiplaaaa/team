...
<div class="card">
  <section class="container">
    <div class="row clearfix" style="margin-top: 10px">
      ...
      <div class="col-lg-3 col-md-3 col-sm-6">
    <div class="info-box-4 hover-zoom-effect">
        <div class="icon"> <i class="zmdi zmdi-male-female col-purple"></i> </div>
        <div class="content">
            <div class="text">Male Patients</div>
            <div class="number">
                <?php
                $male_sql = "SELECT * FROM patient WHERE gender='Male' AND status='Active'";
                $male_qsql = mysqli_query($con, $male_sql);
                echo mysqli_num_rows($male_qsql);
                ?>
            </div>
        </div>
    </div>
...
<div class="col-lg-3 col-md-3 col-sm-6">
    <div class="info-box-4 hover-zoom-effect">
        <div class="icon"> <i class="zmdi zmdi-female col-pink"></i> </div>
        <div class="content">
            <div class="text">Female Patients</div>
            <div class="number">
                <?php
                $female_sql = "SELECT * FROM patient WHERE gender='Female' AND status='Active'";
                $female_qsql = mysqli_query($con, $female_sql);
                echo mysqli_num_rows($female_qsql);
                ?>
            </div>
        </div>
    </div>
